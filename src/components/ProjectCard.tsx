...
export const ProjectCard: React.FC<ProjectCardProps> = ({ project, index }) => {
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-zinc-950 to-black border border-gray-800 hover:border-gray-600 transition-all duration-500 hover:shadow-2xl hover:shadow-blue-500/10">
        ...
        <div className="p-6 bg-gradient-to-r backdrop-blur-sm">
          ...
          <h3 className="text-xl font-semibold text-white mb-3 group-hover:text-white-100 transition-colors">
            {project.title}
          </h3>
