...
const ProjectDetail = () => {
  ...
  const project = {
    ...
    overview: 'A comprehensive AI-powered healthcare platform designed to streamline diagnostic processes and improve patient outcomes through intelligent data visualization and user-friendly interfaces.',
    challenge: 'Healthcare professionals needed a unified platform to access patient data, AI-powered insights, and diagnostic tools while maintaining strict compliance with healthcare regulations.',
    solution: 'Designed an intuitive dashboard that presents complex medical data in digestible formats, implemented role-based access controls, and created seamless workflows for different user types.',
    images: [
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="pt-24 pb-16 px-6">
        <div className="max-w-4xl mx-auto">
          <Link to="/projects" className="inline-flex items-center text-gray-400 hover:text-white transition-colors mb-8">
            <ArrowLeft size={20} className="mr-2" />
            Back to Projects
          </Link>
          
          <div className="mb-12">
            <h1 className="text-6xl font-thin mb-6 animate-fade-in">{project.title}</h1>
            <div className="grid md:grid-cols-2 gap-8 text-gray-400">
              ...
              <div>
                ...
                <div className="mb-4">
                  <span className="text-white">Duration:</span> {project.duration}
                </div>
                <div className="mb-4">
