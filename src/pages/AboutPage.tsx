        ...
        <div className="section-inner">
          ...
          <div className="exp-list" role="list" aria-label="Work experience">
            {[
              ...
              { role:'UI/UX Designer', company:'Rara Digital Lab Pvt. Ltd.', period:'2022–2024', desc:'Rara Digital Labs is a software agency delivering custom digital products across enterprise, healthcare, fintech, and government sectors. I designed 9+ distinct products during my tenure including Myra ERP, Rara EMS, XUNO Fintech, NAC GSE inventory system, Heliski International booking marketplace, and a healthcare platform spanning web apps, mobile apps, PWAs, and admin panels across industries.', link:'raraspace.html', url:'https://raralabs.com/' },
              ...
              <article className="exp-item" role="listitem" key={i}>
                ...
                <div className="exp-right">
                  ...
                  {exp.link && (
                    <a href={exp.link} className="exp-link" target="_self">View Case Study &rarr;</a>
                  )}
                </div>
              </article>
            ))}
